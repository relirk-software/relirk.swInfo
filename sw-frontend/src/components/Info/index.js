...
export default function Info() {
  return (
    <main className="content">
      ...
      <img className="imagem-1" src="img/wolf1.jpg" alt="Wolf 1" />
      ...
      <img className="imagem-2" src="img/wolf2.jpg" alt="Wolf 2" />
      ...
      <img className="col-wide" src="img/wolf3.jpg" alt="Wolf 3" />
    </main>
  );
}
